  ...
  return (
    <div className="min-h-screen flex bg-[#fef8f3]">
      ...
      <div className="hidden lg:flex flex-col justify-between w-80 bg-gradient-to-b from-[#81001d] to-[#a51c30] p-10 shadow-2xl">
        ...
        <div>
          <span className="material-symbols-outlined text-white/20 text-[120px] block mb-4" style={{ fontVariationSettings: "'FILL' 1" }}>shield</span>
          <p className="text-white/60 text-sm leading-relaxed">Quantum-safe cryptographic monitoring for enterprise security infrastructure.</p>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center px-8">
        <div className="max-w-md w-full">
          ...
          <div className="mt-8 text-center text-sm text-[#594141]">
            ...
            <Link to="/signup" className="text-[#964900] font-bold hover:text-[#81001d] transition-colors">
              Sign up
            </Link>
          </div>
        </div>
